...
class NetworkManager {
	...
	func getNewslist(page: Int, completion: @escaping(Result<[[String: AnyObject]]>) -> ()) {
		...
		guard let url = URL(string: "https://cfg.tinkoff.ru/news/public/api/platform/v1/getArticles?pageSize=\(pageSettings.pageSize)&pageOffset=\(pageSettings.pageSize * page)") else { return }
